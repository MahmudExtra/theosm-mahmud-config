...
const Navdata = () => {
  ...
  const [isBuoyNetwork, setIsBuoyNetwork] = useState(false);
  const [isSatMonitors, setIsSatMonitors] = useState(false);
  ...
  useEffect(() => {
    ...
    if (iscurrentState !== "BuoyNetwork") {
      setIsBuoyNetwork(false);
    }
  ...
  const menuItems = [
    ...
    },
    {
      ...
      click: function (e) {
        e.preventDefault();
        setIsBuoyNetwork(!isBuoyNetwork);
        setIscurrentState("BuoyNetwork");
        updateIconSidebar(e);
      },
      stateVariables: isBuoyNetwork,
    },
    {
      id: "sat-monitors",
      label: "Sat Monitors",
      icon: "bx bx bx-planet",
      link: "/sat-monitors",
      click: function (e) {
        e.preventDefault();
        setIsSatMonitors(!isSatMonitors);
        setIscurrentState("SatMonitors");
        updateIconSidebar(e);
      },
      stateVariables: isSatMonitors,
    },
    {
      id: "landing",
      label: "Landing",
