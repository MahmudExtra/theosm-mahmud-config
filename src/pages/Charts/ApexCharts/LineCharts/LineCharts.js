...
const BasicLineCharts = ({ dataColors,value }) => {
...
const BrushChart1 = ({ dataColors }) => {
    ...
    var data = generateDayWiseTimeSeries(new Date("5 Jun 1990").getTime(), 80, {
        min: 30,
        max: 35
    });
    ...
    var options = {
      ...
      xaxis: {
        ...
        // if we dont want to show the xaxis
        // labels: {
        //   show: !1,
        // },
      },
      yaxis: {
        ...
        // if we dont want to show the yaxis
        // labels: {
        //   show: !1,
        // },
      },
