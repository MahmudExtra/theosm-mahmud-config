...
import TestPage from "../pages/BuoyNetwork/BuoyNewtork"; // added by Mahmud
...
import SatMonitors from "../pages/SatMonitors/SatMonitors";
...
const authProtectedRoutes = [
  ...
  // Buoy
  { path: "/buoy-network", component: TestPage },
  // SatMonitor
  { path: "/sat-monitors", component: SatMonitors },
  //Pages
  { path: "/pages-starter", component: Starter },
  // { path: "/pages-buoy-network", component: TestPage }, // added by Mahmud
